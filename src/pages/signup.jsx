          ...
          <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
            ...
            <div>
              ...
              <div className="mt-6">
                ...
                <button class="w-full flex items-center bg-white border border-gray-300 rounded-lg shadow px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 justify-center">
